...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?= base_url('User/create'); ?>" class="btn btn-danger"> <i class="fa fa-plus"></i> Tambah Data </a>
</div>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a data-toggle="tooltip" data-placement="bottom" title="Detail Data"
                                    href="<?=base_url('User/show/'.$value->id_user)?>" class="btn btn-primary btn-sm"><i
                                        class="fa fa-eye"></i></a>
                                <a data-toggle="tooltip" data-placement="bottom" title="Edit Data"
                                    href="<?=base_url('User/edit/'.$value->id_user)?>" class="btn btn-warning btn-sm"><i
