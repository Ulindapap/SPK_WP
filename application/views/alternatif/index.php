...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?= base_url('Alternatif/create'); ?>" class="btn btn-danger"> <i class="fa fa-plus"></i> Tambah Data </a>
</div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-danger"><i class="fa fa-table"></i> Daftar Data Mata Kuliah</h6>
    </div>
