            ...
            <div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                    <div class="text-justify card-body p-0 text-dark">
                        ...
                        <p class="pt-4">
                            Sistem Pendukung Keputusan (SPK) merupakan suatu sistem informasi spesifik yang ditujukan
                            untuk membantu manajemen dalam mengambil keputusan yang berkaitan dengan persoalan yang
                            bersifat semi terstruktur.
                        </p>
                        <p>
                            Program Studi Desain Komunikasi Visual menyedian mata kuliah pilihan bagi mahasiswa pada
                            semester 6 dan 7. mata kuliah pilihan tersebut dapat dipilih berdasarkan minat mahasiswa
                            yang dapat digunakan sebagai penunjang tugas akhir mahasiswa
                        </p>
                    </div>
                </div>
            </div>
