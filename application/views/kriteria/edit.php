        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input autocomplete="off" type="text" name="kode_kriteria"
                    value="<?php echo $kriteria->kode_kriteria ?>" required class="form-control" />
            </div>

            <div class="form-group col-md-6">
                <label class="font-weight-bold">Nama Kriteria</label>
                <input autocomplete="off" type="text" name="keterangan" value="<?php echo $kriteria->keterangan ?>"
                    required class="form-control" />
            </div>

            <div class="form-group col-md-6">
                <label class="font-weight-bold">Bobot Kriteria</label>
                <input autocomplete="off" type="number" name="bobot" step="0.01" value="<?php echo $kriteria->bobot ?>"
                    required class="form-control" />
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <select name="jenis" class="form-control" required>
                    <option value="Benefit" <?php if($kriteria->jenis == "Benefit"){ echo 'selected'; } ?>>Benefit
                    </option>
